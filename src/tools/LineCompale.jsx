		...
		return (
			<div className='LineCompale' style={{ position: 'absolute', ...this.theme }}>
				<div style={{ ...this.theme.title }}>
					<div style={{ width: "20px", height: "20px", position: "absolute", top: "0px", left: "750px" }} id="kuan" className="small-icon" onClick={() => {
					...
					<div style={{ width: "20px", height: "20px", position: "absolute", top: "0px", left: "775px" }} className="small-icon" onClick={() => {
						let stateBar = document.getElementById("select")
						stateBar.onmousedown = null
						DeletTemp()
					...
					<div className="small-icon" style={{ width: "20px", height: "20px", position: "absolute", top: "0px", left: "725px" }} onClick={() => {
						DeletTemp()
						this.DelectAllg()
						this.LineRender()
					}}>
					...
					<div className="small-icon" style={{ width: "20px", height: "20px", position: "absolute", top: "0px", left: "700px" }} onClick={() => {
						DeletTemp()
						this.DelectAllg()
